...
"learn_complete_beginners_guide":["",[["conscurrency",[],["channels.rs","mod.rs","mutex.rs","trheads.rs"]],["error_handling",[],["errors.rs","helper_methos.rs","mod.rs","question_operator.rs","working_with_files.rs"]],["memory_mng",[],["borrowing.rs","lifetimes.rs","mod.rs","onwnership.rs","refernce_counted_variables.rs"]]],["comments.rs","constant.rs","control_structures.rs","crates.rs","data_types.rs","dynamic_dispatch.rs","functions.rs","main.rs","modules.rs","operators.rs","print_values.rs","static_diatch.rs","traits.rs","variables.rs"]],\
